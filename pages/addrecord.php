      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li ><a href="addrecord.php"><button class="btn bg-orange"><i class="fa fa-folder-o"></i>Add Record</button></a></li>
            <li><a href="findrecord.php"><button class="btn bg-orange"><i class="fa fa-folder-o"></i>Find Record</button></a></li>
             <li ><a href="addlocation.php"><button class="btn bg-orange"><i class="fa fa-folder-o"></i>Add Location</button></a></li>
